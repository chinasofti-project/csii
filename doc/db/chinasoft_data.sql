INSERT INTO `basic` (`id`, `step`, `status`, `department`, `hsbc_bu`, `hr`, `rm`, `csi_interviewer`, `csi_interview_email`, `hsbc_interviewer`, `hsbc_interviewer_email`, `cn_name`, `en_name`, `gender`, `phone`, `home_province`, `home_city`, `work_location`, `card_number`, `university`, `degree`, `major`, `graduation_date`, `skills`, `certification`, `lead_experience`, `mf_as400`, `change_job`, `create_time`, `update_time`, `personal_email`) VALUES
